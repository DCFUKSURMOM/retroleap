...
ifneq ($(BR2_ENABLE_DEBUG):$(BR2_STRIP_strip),y:)
	...
	( \
		echo "NAME=Retroleap"; \
		echo "VERSION=$(RL_VERSION), Buildroot $(BR2_VERSION_FULL)"; \
		echo "ID=retroleap"; \
		echo "VERSION_ID=$(RL_VERSION), Buildroot $(BR2_VERSION)"; \
		echo "PRETTY_NAME=\"Retroleap $(RL_VERSION), Buildroot $(BR2_VERSION)\"" \
